...
router.get('/upcoming', authenticateJWT, requirePromoteurAccess, requirePlanCapability('calendarAppointments'), AppointmentController.getUpcomingAppointments);
...
router.get('/project/:projectId', authenticateJWT, requirePromoteurAccess, requirePlanCapability('calendarAppointments'), AppointmentController.getProjectAppointments);
router.patch('/:id/confirm', authenticateJWT, requirePromoteurAccess, requirePlanCapability('calendarAppointments'), AppointmentController.confirmAppointment);
router.patch('/:id/complete', authenticateJWT, requirePromoteurAccess, requirePlanCapability('calendarAppointments'), AppointmentController.completeAppointment);
