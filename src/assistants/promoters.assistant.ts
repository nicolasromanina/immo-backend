...
export const PROMOTER_SYSTEM_PROMPT = `Tu es l'assistant IA dédié aux promoteurs immobiliers sur TrustImmo.
...
export class PromoterAssistant {
  getSystemPrompt(): ChatMessage {
    return {
      role: 'system',
      content: PROMOTER_SYSTEM_PROMPT,
    };
  }
