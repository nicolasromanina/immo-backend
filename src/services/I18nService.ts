...
export class I18nService {
  private static defaultLocale: Locale = 'fr';

  /**
   * Translate a key for a given locale
   */
  static t(key: string, locale?: Locale, params?: Record<string, string>): string {
   ...
   */
  static getTranslations(locale: Locale): Record<string, string> {
   ...
   */
  static addTranslations(locale: Locale, newTranslations: Record<string, string>): void {
