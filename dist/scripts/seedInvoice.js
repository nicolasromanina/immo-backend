...
async function seedInvoice() {
    try {
        ...
        let promoteur = await Promoteur_1.default.findOne({});
        if (!promoteur) {
            ...
            promoteur = new Promoteur_1.default({
                user: user._id,
        ...
        const user = await mongoose_1.default.model('User').findById(promoteur.user).select('email firstName lastName');
        ...
        const pendingInvoice = await Invoice_1.default.create({
            promoteur: promoteur._id,
