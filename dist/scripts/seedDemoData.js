...
async function seedDemoData() {
    try {
        ...
        await User_1.default.deleteMany({ email: /demo|test/ });
        await Promoteur_1.default.deleteMany({ organizationName: /Demo|Test/ });
        // Create demo promoteur user
        const promoteurUser = new User_1.default({
        ...
        const savedProjects = await Project_1.default.insertMany(projects);
        ...
        const savedDocuments = await Document_1.default.insertMany(documents);
        ...
        await Lead_1.default.insertMany(leads);
