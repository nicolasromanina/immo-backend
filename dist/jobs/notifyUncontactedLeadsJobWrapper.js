...
exports.startUncontactedLeadsNotificationJob = void 0;
 ...
 */
const startUncontactedLeadsNotificationJob = () => {
        ...
        try {
            ...
            try {
                await AuditLogService_1.AuditLogService.log({
                    ...
                    category: 'lead',
                    description: `Job failed: ${error?.message || 'Unknown error'}`,
                });
            }
            catch (auditError) {
...
exports.startUncontactedLeadsNotificationJob = startUncontactedLeadsNotificationJob;
