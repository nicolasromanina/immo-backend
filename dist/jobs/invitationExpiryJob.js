...
exports.startInvitationExpiryJob = void 0;
const node_cron_1 = __importDefault(require("node-cron"));
const startInvitationExpiryJob = () => {
...
exports.startInvitationExpiryJob = startInvitationExpiryJob;
const invitationExpiryJob = async () => {
    const { default: OrganizationInvitation } = await Promise.resolve().then(() => __importStar(require('../models/OrganizationInvitation')));
