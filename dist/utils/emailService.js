...
exports.sendBulkEmails = exports.sendTemplateEmail = exports.sendEmail = void 0;
...
const sendTemplateEmail = async (to, templateName, data) => {
    return (0, exports.sendEmail)({ to, subject: '', template: templateName, data });
};
...
const sendBulkEmails = async (recipients, emailData) => {
    ...
    for (const to of recipients) {
        try {
            await (0, exports.sendEmail)({ ...emailData, to });
            sent++;
        }
        catch {
            failed++;
