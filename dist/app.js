...
const documentAccessRequestRoutes_1 = __importDefault(require("./routes/documentAccessRequestRoutes"));
...
const projectBrochureRoutes_1 = __importDefault(require("./routes/projectBrochureRoutes"));
...
app.use('/api/document-access-requests', documentAccessRequestRoutes_1.default);
...
app.use('/api/project-brochures', projectBrochureRoutes_1.default);
