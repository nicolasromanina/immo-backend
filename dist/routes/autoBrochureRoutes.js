...
router.post('/promoteur/project/:projectId', (0, auth_1.authorizeRoles)(roles_1.Role.PROMOTEUR), (0, planEntitlements_1.requirePlanCapability)('autoBrochure'), autoBrochureController_1.generatePromoteurBrochure);
