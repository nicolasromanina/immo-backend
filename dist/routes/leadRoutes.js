...
router.get('/export/csv', auth_1.authenticateJWT, promoteurRbac_1.requirePromoteurAccess, (0, promoteurRbac_1.requirePromoteurPermission)('exportLeads'), leadController_1.LeadController.exportLeads);
...
router.put('/:id/status', auth_1.authenticateJWT, promoteurRbac_1.requirePromoteurAccess, (0, promoteurRbac_1.requirePromoteurPermission)('editLeads'), leadController_1.LeadController.updateLeadStatus);
...
router.post('/:id/assign', auth_1.authenticateJWT, promoteurRbac_1.requirePromoteurAccess, (0, promoteurRbac_1.requirePromoteurPermission)('assignLeads'), leadController_1.LeadController.assignLead);
