...
// Promoteur routes
router.get('/sla/my-dashboard', auth_1.authenticateJWT, (0, auth_1.authorizeRoles)(roles_1.Role.PROMOTEUR), reportingController_1.ReportingController.getMySLADashboard);
router.get('/sanctions/my-history', auth_1.authenticateJWT, (0, auth_1.authorizeRoles)(roles_1.Role.PROMOTEUR), reportingController_1.ReportingController.getMySanctionHistory);
// Admin routes
...
router.get('/promoteur/me', auth_1.authenticateJWT, (0, auth_1.authorizeRoles)(roles_1.Role.PROMOTEUR), reportingController_1.ReportingController.getMyPromoteurReport);
