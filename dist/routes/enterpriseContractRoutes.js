...
router.get('/my', auth_1.authenticateJWT, (0, auth_1.authorizeRoles)(roles_1.Role.PROMOTEUR), enterpriseContractController_1.EnterpriseContractController.getMyContracts);
// Get contract details
router.get('/:id', auth_1.authenticateJWT, enterpriseContractController_1.EnterpriseContractController.getContract);
// Sign contract (promoteur side)
router.post('/:id/sign', auth_1.authenticateJWT, (0, auth_1.authorizeRoles)(roles_1.Role.PROMOTEUR), enterpriseContractController_1.EnterpriseContractController.signByPromoteur);
// Request amendment
router.post('/:id/amendment', auth_1.authenticateJWT, (0, auth_1.authorizeRoles)(roles_1.Role.PROMOTEUR), enterpriseContractController_1.EnterpriseContractController.addAmendment);
// ==================== Admin Endpoints ====================
// Create contract
