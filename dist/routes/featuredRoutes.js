...
// Promoteur endpoints
router.post('/slots', auth_1.authenticateJWT, (0, auth_1.authorizeRoles)(roles_1.Role.PROMOTEUR, roles_1.Role.ADMIN), featuredController_1.FeaturedController.createFeaturedSlot);
router.get('/slots/:id/performance', auth_1.authenticateJWT, (0, auth_1.authorizeRoles)(roles_1.Role.PROMOTEUR, roles_1.Role.ADMIN), featuredController_1.FeaturedController.getSlotPerformance);
router.patch('/slots/:id/cancel', auth_1.authenticateJWT, (0, auth_1.authorizeRoles)(roles_1.Role.PROMOTEUR, roles_1.Role.ADMIN), featuredController_1.FeaturedController.cancelFeaturedSlot);
// Admin endpoints
