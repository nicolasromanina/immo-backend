...
const ProjectQuestionSchema = new mongoose_1.Schema({
    ...
    askedBy: { type: mongoose_1.Schema.Types.ObjectId, ref: 'User', required: true, index: true },
...
exports.default = mongoose_1.default.model('ProjectQuestion', ProjectQuestionSchema);
